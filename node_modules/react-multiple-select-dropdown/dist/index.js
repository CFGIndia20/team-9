...
var PlusIcon = /** @class */ (function (_super) {
    ...
    PlusIcon.prototype.render = function () {
        return (React.createElement("div", __assign({}, this.props, { className: 'icon icon--plus' + (this.props.className ? ' ' + this.props.className : '') }),
            React.createElement("svg", { viewBox: "0 0 11.15 11.15" },
                React.createElement("path", { className: "svg-point", d: "M10.22,4.65H6.51V.93a.93.93,0,1,0-1.86,0V4.65H.93a.93.93,0,0,0,0,1.86H4.65v3.71a.93.93,0,0,0,1.86,0V6.51h3.71a.93.93,0,0,0,0-1.86Z" }))));
    };
    return PlusIcon;
}(React.PureComponent));
...
var TrashIcon = /** @class */ (function (_super) {
    ...
    TrashIcon.prototype.render = function () {
        return (React.createElement("div", __assign({}, this.props, { className: "icon icon--trash" +
                (this.props.className ? " " + this.props.className : "") }),
            React.createElement("svg", { viewBox: "0 0 11.49 14.54" },
                React.createElement("path", { className: "svg-point", d: "M10.5,1.71H8.56V.45A.46.46,0,0,0,8.1,0a.06.06,0,0,0,0,0L8,0H3.39a.45.45,0,0,0-.45.45V1.71H1a1,1,0,0,0-1,1V4.32H.86v9.23a1,1,0,0,0,1,1H9.65a1,1,0,0,0,1-1V4.32h.85V2.7A1,1,0,0,0,10.5,1.71ZM3.84.9H7.65v.81H3.84ZM9.73,13.55c0,.06,0,.08-.08.08H1.84c-.05,0-.08,0-.08-.08V4.32h8Zm.85-10.13H.91V2.7c0-.05,0-.09.08-.09H10.5c.06,0,.08,0,.08.09Z" }),
                React.createElement("rect", { className: "svg-point", x: "7.39", y: "5.38", width: "0.91", height: "7.45" }),
                React.createElement("rect", { className: "svg-point", x: "5.3", y: "5.38", width: "0.91", height: "7.45" }),
                React.createElement("rect", { className: "svg-point", x: "3.2", y: "5.38", width: "0.91", height: "7.45" }))));
    };
    return TrashIcon;
}(React.PureComponent));
...
var VirtualList = /** @class */function (_super) {
    ...
    VirtualList.prototype.render = function () {
        ...
        return React.createElement("div", __assign$1({ ref: this.getRef }, props, { style: wrapperStyle }), React.createElement("div", { style: innerStyle }, items));
        var _e;
    };
...
var DesktopList = /** @class */ (function (_super) {
    ...
    function DesktopList(props) {
        ...
        _this.unSelectedRow = function (_a) {
            ...
            return (React.createElement("div", { style: style, key: index, className: "multiple-select_list_item" + (currentList === ListType.unselected && acvtiveUnselectedItem === index ? " js-active" : "") },
                "\t\t\t\t",
                React.createElement("li", { onClick: function () { return _this.onSelectItem(index); }, role: "option" }, renderUnSelectedOption ? renderUnSelectedOption(unSelectedList[index]) : React.createElement("span", null, unSelectedList[index].label))));
        };
        _this.selectedRow = function (_a) {
            ...
            return (React.createElement("div", { style: style, key: index, className: "multiple-select_list_item" + (currentList === ListType.selected && acvtiveSelectedItem === index ? " js-active" : "") },
                React.createElement("li", { onClick: function () { return _this.onDeselectItem(index); } }, renderSelectedOption ? renderSelectedOption(selectedOptions[index]) : React.createElement(React.Fragment, null,
                    React.createElement("span", null, selectedOptions[index].label),
    ...
    DesktopList.prototype.render = function () {
        ...
        var unSelectedList = (React.createElement("div", { className: "multiple-select_list multiple-select_list--unselected" + (addable ? " js-addable" : ""), role: "listbox", "aria-labelledby": "ss_elem" },
            React.createElement(VirtualList, { height: 200, itemCount: this.state.unSelectedList.length, itemSize: 40, width: 240, style: { overflowY: 'auto', overflowX: 'initial' }, className: "multiple-select_list--unselected--virutual", renderItem: this.unSelectedRow })));
        var selectedList = (React.createElement("div", { className: "multiple-select_list multiple-select_list--selected" },
            React.createElement(VirtualList, { height: 200, itemCount: selectedOptions.length, itemSize: 40, width: 240, style: { overflowY: 'auto', overflowX: 'initial' }, className: "multiple-select_list--selected--virutual", renderItem: this.selectedRow })));
        return (React.createElement("div", { className: 'multiple-select_lists' + ' ' + theme, style: { width: !!selectedOptions.length ? 480 : 240 } },
            React.createElement("div", { className: "multiple-select_lists_inner" },
                unSelectedList,
...
var MultipleSelect = /** @class */ (function (_super) {
    ...
    function MultipleSelect(props) {
        ...
        _this.selectWrapRef = React.createRef();
    ...
    MultipleSelect.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "multiple-select_wrap", ref: this.selectWrapRef },
            React.createElement("div", { className: "multiple-select_summary_wrap", hidden: showLists || selectedOptions.length < 1 },
                React.createElement("span", { onClick: this.onFocus },
                    selectedOptions.length > 0 ? selectedOptions[0].label : "",
                    selectedOptions.length > 1 && "...")),
            React.createElement("div", { className: "multiple-select_trigger" },
                React.createElement("input", { onChange: function (e) {
                        if (onInputChange) {
                            onInputChange(e.target.value);
                        }
                    }, onFocus: this.onFocus, onBlur: this.onBlur, ref: this.inputRef })),
            showLists && React.createElement(DropDownWrap, { className: "multiple-select_dropdown_wrap", top: this.selectWrapRef.current ? this.selectWrapRef.current.clientHeight : 0 },
                React.createElement(DesktopList, __assign({}, this.props, { onBlur: this.onBlur, onFocus: this.onFocus })))));
    };
...
var SelectedList = function (_a) {
    ...
    return (React.createElement("div", { className: "multiple-select_list multiple-select_list--selected" },
        React.createElement(VirtualList, { height: 200, itemCount: selectedOptions.length, itemSize: 40, width: 240, style: { overflowY: 'auto', overflowX: 'initial' }, className: "multiple-select_list--selected--virutual", renderItem: selectedRow })));
};

var UnSelectedList = function (_a) {
    var unSelectedList = _a.unSelectedList, unSelectedRow = _a.unSelectedRow;
    return (React.createElement("div", { className: "multiple-select_list multiple-select_list--unselected", role: "listbox", "aria-labelledby": "ss_elem" },
        React.createElement(VirtualList, { height: 200, itemCount: unSelectedList.length, itemSize: 40, width: 240, style: { overflowY: 'auto', overflowX: 'initial' }, className: "multiple-select_list--unselected--virutual", renderItem: unSelectedRow })));
};
...
var MobileList = /** @class */ (function (_super) {
    ...
    function MobileList(props) {
        ...
        _this.unSelectedRow = function (_a) {
            ...
            return (React.createElement("div", { style: style, key: index, className: "multiple-select_list_item" },
                React.createElement("li", { onClick: function () { return _this.onSelectItem(index); }, role: "option" }, renderUnSelectedOption ? renderUnSelectedOption(unSelectedList[index]) : React.createElement("span", null, unSelectedList[index].label))));
        };
        _this.selectedRow = function (_a) {
            var index = _a.index, style = _a.style;
    ...
    MobileList.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "multiple-select_lists", style: { width: 240 } },
            React.createElement("div", { className: "multiple-select_tab_header" },
                React.createElement("div", { className: "multiple-select_tab_header_item" + (currentTab === "unselected" ? " js-active" : ""), onClick: function () { _this.setState({ currentTab: "unselected" }); } },
                    React.createElement("span", null, unselectedTabLabel)),
                React.createElement("div", { className: "multiple-select_tab_header_item" + (currentTab === "selected" ? " js-active" : ""), onClick: function () { _this.setState({ currentTab: "selected" }); } },
                    React.createElement("span", null, selectedTabLabel))),
            currentTab === "unselected" ?
                React.createElement("div", null,
                    React.createElement(UnSelectedList, { unSelectedList: unSelectedList, unSelectedRow: this.unSelectedRow }))
                : React.createElement("div", null,
                    React.createElement(SelectedList, { selectedOptions: selectedOptions, selectedRow: this.selectedRow }))));
    };
...
var MultipleSelect$1 = /** @class */ (function (_super) {
    ...
    MultipleSelect.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "multiple-select_wrap", ref: this.selectWrapRef },
            React.createElement("div", { className: "multiple-select_summary_wrap", hidden: showLists || selectedOptions.length < 1 },
                React.createElement("span", { className: "multiple-select_summary", onClick: this.onFocus },
                    selectedOptions.length > 0 ? selectedOptions[0].label : "",
                    selectedOptions.length > 1 && "...")),
            React.createElement("div", { className: "multiple-select_trigger" },
                React.createElement("input", { onChange: function (e) {
            ...
            showLists && React.createElement(DropDownWrap, { className: "multiple-select_dropdown_wrap", top: this.selectWrapRef.current ? this.selectWrapRef.current.clientHeight : 0 },
                React.createElement(MobileList, __assign({}, this.props, { onBlur: this.onBlur, onFocus: this.onFocus })))));
    };
    MultipleSelect.defaultProps = {
        selectedTabLabel: "selected",
        unselectedTabLabel: "unselected"
...
var MultipleSelect$2 = function (props) { return (React.createElement(React.Fragment, null,
    React.createElement("div", { className: "multiple-select--desktop" },
        React.createElement(MultipleSelect, __assign({}, props, { direction: props.direction || "rtl" }))),
    React.createElement("div", { className: "multiple-select--mobile" },
        React.createElement(MultipleSelect$1, __assign({}, props))))); };

exports.default = MultipleSelect$2;
exports.DesktopList = DesktopList;
